...
Original file is located at
    https://colab.research.google.com/drive/16Ic_VB5tHJDr6wgzY_t49TdUg9ZE5g3R
"""
...
# --------- تحميل النماذج مرة واحدة عند بدء الخدمة ----------
...
def analyze():
    if "image" not in request.files:
        return jsonify({"error": "No image uploaded (use multipart/form-data with field name 'image')"}), 400
